...
def call(tokensq, boolean bool_1, boolean bool_2) {
    ...
    def Result2 = sh (script: "${scannerHome}/bin/sonar-scanner -Dsonar.projectKey=${PROJECT_NAME} -Dsonar.login=${tokensq} -Dsonar.host.url=${SONAR_HOST_URL} -Dsonar.qualitygate.timeout=300", returnStdout: true)
    println Result2
